...
namespace feedme.Server.Data.Migrations
{
    ...
    [Migration("20251028193704_AddCatalogItemFlags")]
    partial class AddCatalogItemFlags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("catalog_item_flags", b =>
                {
                    b.Property<string>("catalog_item_id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
                        .HasColumnName("catalog_item_id");

                    b.Property<Guid>("flag_id")
                        .HasColumnType("uuid")
                        .HasColumnName("flag_id");

                    b.HasKey("catalog_item_id", "flag_id");

                    b.HasIndex("flag_id");

                    b.ToTable("catalog_item_flags", (string)null);
                });
            ...
            modelBuilder.Entity("feedme.Server.Models.ProductFlag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("catalog_item_flags", b =>
                {
                    b.HasOne("feedme.Server.Models.CatalogItem", null)
                        .WithMany()
                        .HasForeignKey("catalog_item_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("feedme.Server.Models.ProductFlag", null)
                        .WithMany()
